    ...
    struct BDT{
        public:
            ...
            void decision_function(input_t x, score_t score[fn_classes(n_classes)]) const {
                ...
                scores[0][0] = trees[0][0].decision_function(x);
                scores[0][1] = trees[0][1].decision_function(x);
                scores[0][2] = trees[0][2].decision_function(x);
                scores[0][3] = trees[0][3].decision_function(x);
                scores[0][4] = trees[0][4].decision_function(x);
                scores[0][5] = trees[0][5].decision_function(x);
                scores[0][6] = trees[0][6].decision_function(x);
                scores[0][7] = trees[0][7].decision_function(x);
                scores[0][8] = trees[0][8].decision_function(x);
                scores[0][9] = trees[0][9].decision_function(x);
